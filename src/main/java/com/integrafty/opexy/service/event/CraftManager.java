...
public class CraftManager extends ListenerAdapter {
    ...
    private static final List<Recipe> RECIPES = List.of(
            ...
            new Recipe(new String[][] { { "W", "W", "E" }, { "W", "W", "E" }, { "E", "E", "E" } },
                    List.of("ورك بينش", "طاولة صنع", "crafting table", "workbench", "طاوله صنع", "طاولة الصناعة",
                            "كرفتنق تيبل", "كرافتنق تيبل"),
                    "طاولة صنع", Difficulty.EASY),
            new Recipe(new String[][] { { "W", "E", "E" }, { "W", "E", "E" }, { "E", "E", "E" } },
                    List.of("عصا", "stick", "عصاي", "العصا", "ستيك"), "عصا", Difficulty.EASY),
            new Recipe(new String[][] { { "W", "W", "W" }, { "W", "W", "W" }, { "W", "W", "W" } },
                    List.of("بلوك خشب", "wood block", "خشب", "الخشب", "بلوك الخشب", "planks", "wood"), "بلوك خشب",
                    Difficulty.EASY),
            new Recipe(new String[][] { { "C", "E", "E" }, { "S", "E", "E" }, { "E", "E", "E" } },
                    List.of("شمعة", "torch", "شعلة", "شمعه", "شعلة نار", "تورتش"), "شمعة", Difficulty.EASY),
            new Recipe(new String[][] { { "S", "E", "S" }, { "S", "S", "S" }, { "S", "E", "S" } },
                    List.of("سلم", "ladder", "سلم خشب", "السلم", "لادر"), "سلم خشب", Difficulty.EASY),
            new Recipe(new String[][] { { "W", "W", "E" }, { "W", "W", "E" }, { "W", "W", "E" } },
                    List.of("باب", "door", "باب خشب", "الباب", "دور"), "باب خشب", Difficulty.EASY),
            new Recipe(new String[][] { { "W", "W", "W" }, { "E", "E", "E" }, { "E", "E", "E" } },
                    List.of("سلاب", "slab", "بلاطة", "بلاطة خشب", "بلاطه"), "بلاطة خشب", Difficulty.EASY),

            // MEDIUM
            new Recipe(new String[][] { { "E", "D", "E" }, { "E", "D", "E" }, { "E", "S", "E" } },
                    List.of("سيف", "sword", "سيف دايموند", "سيف الدايموند", "السيف", "دايموند سورد"), "سيف دايموند",
                    Difficulty.MEDIUM),
            new Recipe(new String[][] { { "D", "D", "D" }, { "E", "S", "E" }, { "E", "S", "E" } },
                    List.of("بيكاكس", "pickaxe", "فأس", "بيكاكس دايموند", "بيكاكس الدايموند", "الفأس",
                            "دايموند بيكاكس"),
                    "بيكاكس دايموند", Difficulty.MEDIUM),
            new Recipe(new String[][] { { "W", "W", "W" }, { "W", "E", "W" }, { "W", "W", "W" } },
                    List.of("صندوق", "chest", "تشيست", "الصندوق", "صندوق خشب"), "صندوق", Difficulty.MEDIUM),
            new Recipe(new String[][] { { "E", "S", "L" }, { "S", "E", "L" }, { "E", "S", "L" } },
                    List.of("قوس", "bow", "سهم", "القوس", "سهم وقوس", "بوو"), "قوس", Difficulty.MEDIUM),
            new Recipe(new String[][] { { "E", "E", "S" }, { "E", "S", "L" }, { "S", "E", "L" } },
                    List.of("صنارة", "fishing rod", "صنارة صيد", "الصنارة", "صناره", "فيشنق رود"), "صنارة صيد",
                    Difficulty.MEDIUM),
            new Recipe(new String[][] { { "I", "I", "I" }, { "I", "E", "I" }, { "E", "E", "E" } },
                    List.of("خوذة", "helmet", "خوذة حديد", "خوذه", "الخوذة", "هيلت"), "خوذة حديد", Difficulty.MEDIUM),
            new Recipe(new String[][] { { "E", "I", "E" }, { "I", "R", "I" }, { "E", "I", "E" } },
                    List.of("بوصلة", "compass", "البوصلة", "بوصله", "كمباس"), "بوصلة", Difficulty.MEDIUM),
            new Recipe(new String[][] { { "E", "G", "E" }, { "G", "R", "G" }, { "E", "G", "E" } },
                    List.of("ساعة", "clock", "ساعه", "الساعة", "كلوك"), "ساعة", Difficulty.MEDIUM),

            // HARD
            new Recipe(new String[][] { { "I", "I", "I" }, { "E", "S", "E" }, { "E", "S", "E" } },
                    List.of("بيكاكس حديد", "iron pickaxe", "بيكاكس الحديد", "ايرون بيكاكس"), "بيكاكس حديد",
                    Difficulty.HARD),
            new Recipe(new String[][] { { "G", "G", "G" }, { "E", "S", "E" }, { "E", "S", "E" } },
                    List.of("بيكاكس ذهب", "gold pickaxe", "بيكاكس الذهب", "قولد بيكاكس"), "بيكاكس ذهب",
                    Difficulty.HARD),
            new Recipe(new String[][] { { "P", "P", "P" }, { "P", "R", "P" }, { "P", "P", "P" } },
                    List.of("خريطة", "map", "ماب", "خريطة فارغة", "الخريطة"), "خريطة فارغة", Difficulty.HARD),
            new Recipe(new String[][] { { "B", "B", "B" }, { "B", "E", "B" }, { "B", "B", "B" } },
                    List.of("فرن", "furnace", "الفرن", "فرنيس"), "فرن حجري", Difficulty.HARD),
            new Recipe(new String[][] { { "E", "H", "E" }, { "D", "O", "D" }, { "O", "O", "O" } },
                    List.of("طاولة تطوير", "enchantment table", "تطوير", "طاوله تطوير", "طاولة التطوير",
                            "انشانتمنت تيبل"),
                    "طاولة تطوير", Difficulty.HARD),
            new Recipe(new String[][] { { "I", "I", "I" }, { "E", "I", "E" }, { "I", "I", "I" } },
                    List.of("سندان", "anvil", "السندان", "انفيل"), "سندان", Difficulty.HARD),
            new Recipe(new String[][] { { "W", "W", "W" }, { "W", "R", "W" }, { "W", "W", "W" } },
                    List.of("نوت بلوك", "note block", "موسيقى", "النوت بلوك"), "نوت بلوك", Difficulty.HARD),
            new Recipe(new String[][] { { "I", "E", "I" }, { "I", "I", "I" }, { "I", "I", "I" } },
                    List.of("درع", "chestplate", "درع حديد", "الدرع", "درع الحديد", "تشيست بليت"), "درع حديد",
                    Difficulty.HARD),
            new Recipe(new String[][] { { "G", "G", "G" }, { "G", "A", "G" }, { "G", "G", "G" } },
                    List.of("تفاحة ذهبية", "golden apple", "تفاحة ذهب", "قولدن ابل", "جولدن ابل"), "تفاحة ذهبية",
                    Difficulty.HARD),
            new Recipe(new String[][] { { "O", "O", "O" }, { "O", "N", "O" }, { "O", "O", "O" } },
                    List.of("صندوق اندر", "ender chest", "اندر تشيست"), "صندوق اندر", Difficulty.HARD),
            new Recipe(new String[][] { { "X", "X", "X" }, { "X", "K", "X" }, { "O", "O", "O" } },
                    List.of("بيكون", "beacon", "منارة", "بيكن"), "بيكون", Difficulty.HARD),
            new Recipe(new String[][] { { "F", "Z", "F" }, { "Z", "F", "Z" }, { "F", "Z", "F" } },
                    List.of("تي ان تي", "tnt", "متفجرات"), "TNT", Difficulty.HARD),
            new Recipe(new String[][] { { "E", "I", "E" }, { "E", "S", "E" }, { "E", "J", "E" } },
                    List.of("سهم", "arrow", "سهام"), "سهم", Difficulty.HARD),

            // TOOLS (DIAMOND)
            new Recipe(new String[][] { { "D", "D", "E" }, { "D", "S", "E" }, { "E", "S", "E" } },
                    List.of("فأس دايموند", "diamond axe", "فأس", "الفأس"), "فأس دايموند", Difficulty.MEDIUM),
            new Recipe(new String[][] { { "E", "D", "E" }, { "E", "S", "E" }, { "E", "S", "E" } },
                    List.of("مجرفة دايموند", "diamond shovel", "مجرفة", "مجرفه"), "مجرفة دايموند", Difficulty.EASY),
            new Recipe(new String[][] { { "D", "D", "E" }, { "E", "S", "E" }, { "E", "S", "E" } },
                    List.of("فأس زراعة", "diamond hoe", "محراث"), "فأس زراعة دايموند", Difficulty.MEDIUM),

            // ARMOR (DIAMOND)
            new Recipe(new String[][] { { "D", "E", "D" }, { "D", "E", "D" }, { "E", "E", "E" } },
                    List.of("حذاء دايموند", "diamond boots", "بوت", "حذاء"), "حذاء دايموند", Difficulty.EASY),
            new Recipe(new String[][] { { "D", "D", "D" }, { "D", "E", "D" }, { "D", "E", "D" } },
                    List.of("سروال دايموند", "diamond leggings", "بنطلون", "سروال"), "سروال دايموند", Difficulty.HARD),

            // UTILITY
            new Recipe(new String[][] { { "I", "E", "E" }, { "E", "I", "E" }, { "E", "E", "E" } },
                    List.of("مقص", "shears", "المقص"), "مقص", Difficulty.EASY),
            new Recipe(new String[][] { { "I", "E", "I" }, { "E", "I", "E" }, { "E", "E", "E" } },
                    List.of("سطل", "bucket", "سطل حديد", "جردل"), "سطل حديد", Difficulty.MEDIUM),
            new Recipe(new String[][] { { "W", "E", "W" }, { "E", "W", "E" }, { "E", "E", "E" } },
                    List.of("وعاء", "bowl", "صحن"), "وعاء خشبي", Difficulty.EASY),
            new Recipe(new String[][] { { "P", "P", "P" }, { "E", "E", "E" }, { "E", "E", "E" } },
                    List.of("ورق", "paper", "ورقة"), "ورق", Difficulty.EASY),
            new Recipe(new String[][] { { "WH", "WH", "WH" }, { "E", "E", "E" }, { "E", "E", "E" } },
                    List.of("خبز", "bread", "الخبز"), "خبز", Difficulty.EASY),
            new Recipe(new String[][] { { "WH", "WH", "WH" }, { "WH", "WH", "WH" }, { "WH", "WH", "WH" } },
                    List.of("بلوك قش", "hay bale", "بلوك القش", "قش"), "بلوك قش", Difficulty.MEDIUM),
            new Recipe(new String[][] { { "S", "S", "S" }, { "S", "U", "S" }, { "S", "S", "S" } },
                    List.of("لوحة", "painting", "لوحه"), "لوحة فنية", Difficulty.MEDIUM),
            new Recipe(new String[][] { { "U", "U", "U" }, { "W", "W", "W" }, { "E", "E", "E" } },
                    List.of("سرير", "bed", "السرير"), "سرير", Difficulty.MEDIUM),
            new Recipe(new String[][] { { "W", "S", "W" }, { "W", "S", "W" }, { "E", "E", "E" } },
                    List.of("سياج", "fence", "سور"), "سياج خشبي", Difficulty.MEDIUM),
            new Recipe(new String[][] { { "S", "W", "S" }, { "S", "W", "S" }, { "E", "E", "E" } },
                    List.of("بوابة سياج", "fence gate", "بوابة"), "بوابة سياج", Difficulty.MEDIUM),
            new Recipe(new String[][] { { "B", "B", "B" }, { "B", "L", "B" }, { "B", "R", "B" } },
                    List.of("ديسبنسر", "dispenser", "موزع"), "ديسبنسر", Difficulty.HARD),
            new Recipe(new String[][] { { "X", "X", "X" }, { "Q", "Q", "Q" }, { "W", "W", "W" } },
                    List.of("حساس ضوء", "daylight sensor"), "حساس ضوء الشمس", Difficulty.HARD),
            new Recipe(new String[][] { { "I", "I", "I" }, { "I", "I", "I" }, { "I", "I", "I" } },
                    List.of("بلوك حديد", "iron block"), "بلوك حديد", Difficulty.MEDIUM),
            new Recipe(new String[][] { { "G", "G", "G" }, { "G", "G", "G" }, { "G", "G", "G" } },
                    List.of("بلوك ذهب", "gold block"), "بلوك ذهب", Difficulty.MEDIUM),
            new Recipe(new String[][] { { "D", "D", "D" }, { "D", "D", "D" }, { "D", "D", "D" } },
                    List.of("بلوك دايموند", "diamond block"), "بلوك دايموند", Difficulty.HARD),
            new Recipe(new String[][] { { "M", "M", "M" }, { "M", "M", "M" }, { "M", "M", "M" } },
                    List.of("بلوك زمرد", "emerald block", "بلوك ايمرلد", "ايمرلد بلوك"), "بلوك زمرد", Difficulty.HARD));
    ...
    public void initTimer(String sessionId, Difficulty difficulty,
        ...
        java.util.concurrent.ScheduledFuture<?> future = scheduler.scheduleAtFixedRate(() -> {
            try {
                if (!sessionActiveRecipes.containsKey(sessionId)) return;
                ...
                if (timeLeft[0] <= 0) {
                    ...
                    if (activeRecipe != null) {
                        ...
                        event.getHook().editOriginal(new net.dv8tion.jda.api.utils.messages.MessageEditBuilder()
                                .setComponents(EmbedUtil.error("CRAFTING TIMEOUT",
                                        "`=---------------- 00:00 ----------------=`\n\n" + failMsg))
                ...
                String body = getCraftBody(sessionMentions.get(sessionId), grid, difficulty.reward, timeLeft[0]);
                ...
                hook.editOriginal(new net.dv8tion.jda.api.utils.messages.MessageEditBuilder()
                        .setComponents(
                                EmbedUtil.containerBranded("CRAFTING", "🛠️ ماذا نصنع؟", body, EmbedUtil.BANNER_MAIN))
                        .useComponentsV2(true)
                        .build()).queue(null, e -> {
                            if (e.getMessage() != null && (e.getMessage().contains("Unknown Interaction")
        ...
        for (String sessionId : sessionsToProcess) {
            ...
            if (activeRecipe.possibleNames.contains(content)) {
                ...
                String logWin = String.format(
                        ...
                        event.getAuthor().getId(), activeRecipe.difficulty.displayName, itemName, sessionId);
                logManager.logEmbed(event.getGuild(), LogManager.LOG_GAMES,
                        EmbedUtil.createOldLogEmbed("craft_win", logWin, event.getMember(), null, null,
                                EmbedUtil.SUCCESS));
